...
I'm a Software Engineer pivoting into Cybersecurity, based in Kiel, Germany.

  - 🔐: Currently deepening my skills in cybersecurity — working through TryHackMe rooms and building up my offensive/defensive security fundamentals.

  - 🔍: Background in software development and applied AI/ML, with hands-on experience in low-level systems (microprocessors, assembly, electronic circuits) from my Computer Engineering studies.
